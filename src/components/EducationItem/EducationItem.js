        ...
        <div className={classes.main}>
            <header>
                ...
                <ol className={classes.educationList}>
                    <li className={`${(location.pathname==='/' || location.pathname==='/stage/stage2' || location.pathname==='/stage/stage3' || location.pathname==='/stage3') ?  classes.active : ''}`}>Təhsil</li>
                    <li className={`${(location.pathname==='/stage/stage4' || location.pathname==='/stage/stage5' ) ?  classes.active : ''}`}>Dil bilikləri</li>
