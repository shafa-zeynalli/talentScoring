            ...
            <div className={classes.education__control}>
              ...
              <div className={classes.education__control_Name}>
                <Radio
                  ...
                  style1={{
                    color: selectValues.confirm2 === "yes" ? "#038477" : "#444",
                  }}
                  style2={{
                    backgroundColor:
                      selectValues.confirm2 === "yes" ? "#038477" : "#f2f6f6",
                    appearance: selectValues.confirm2 === "yes" ? "none" : "",
                  }}
                />
                <Radio
                  name="confirm2"
                  ...
                  changeHandlerRadio={handleChangeConfirm}
                  style1={{
                    color: selectValues.confirm2 === "no" ? "#038477" : "#444",
                  }}
                  style2={{
                    backgroundColor:
                      selectValues.confirm2 === "yes" ? "#f2f6f6 " : "#038477",
                    appearance: selectValues.confirm2 === "no" ? "none" : "",
                  }}
                />
              </div>
            </div>
            {(selectValues.confirm2 === "yes" ||
              selectValues.confirm2 === "yes") && (
              <div>
                <Select
