...
const Stage1 = (props) => {
  ...
  const employment =
    selectValues.confirm === "no" ? optionsEmployment : optionsEmployment2;
  ...
  const submitHandler = (event) => {
    ...
    {
      (item.isEducation || selectValues.select2 === todo.select2) &&
        navigate("/stage/stage3");
    }
    {
      !item.isEducation &&
        navigate("/stage/stage2", {
          state: {
            isPeshe: item.isProfession,
            isBachelor: item.isBachelors,
            isMaster: item.isMaster,
            isPHD: item.isDoctoral,
            isSelect: selectValues,
          },
        });
    }
          ...
          <div className={classes.education__control}>
            ...
            <div className={classes.education__control_Name}>
              <Radio
                ...
                style1={{
                  color: selectValues.confirm === "yes" ? "#038477" : "#444",
                }}
                style2={{
                  backgroundColor:
                    selectValues.confirm === "yes" ? "#038477" : "#f2f6f6",
                  appearance: selectValues.confirm === "yes" ? "none" : "",
                }}
              />
              <Radio
                name="confirm"
                ...
                changeHandlerRadio={handleChangeConfirm}
                style1={{
                  color: selectValues.confirm === "no" ? "#038477" : "#444",
                }}
                style2={{
                  backgroundColor:
                    selectValues.confirm === "yes" ? "#f2f6f6 " : "#038477",
                  appearance: selectValues.confirm === "no" ? "none" : "",
                }}
              />
            </div>
          </div>
