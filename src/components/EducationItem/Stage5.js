  ...
  return (
    <Card>
      <div className={classes.education}>
        ...
        <Button onClick={clickHandlerButton} className={classes.button}>
          Əlavə et <div></div>
        </Button>
        {selectValues.isSelectAdd && (
        ...
        <div className={classes.selectLang}>
          {selectValues.isAlmanLang && (
            <>
              <LangRadio
                ...
                value5='c1alman'
                value6='c2alman'
                confirm1={selectValues.almanLang === 'a1alman'}
                confirm2={selectValues.almanLang === 'a2alman'}
                confirm3={selectValues.almanLang === 'b1alman'}
                confirm4={selectValues.almanLang === 'b2alman'}
                confirm5={selectValues.almanLang === 'c1alman'}
                confirm6={selectValues.almanLang === 'c2alman'}
          ...
          {selectValues.isIspanLang && (
            <>
              <LangRadio
                ...
                value5='c1ispan'
                value6='c2ispan'
                confirm1={selectValues.ispanLang === 'a1ispan'}
                confirm2={selectValues.ispanLang === 'a2ispan'}
                confirm3={selectValues.ispanLang === 'b1ispan'}
                confirm4={selectValues.ispanLang === 'b2ispan'}
                confirm5={selectValues.ispanLang === 'c1ispan'}
                confirm6={selectValues.ispanLang === 'c2ispan'}
                changeHandlerRadio={changeHandlerLang}
              />
              <br />
              <br />
          ...
          {selectValues.isFransizLang && (
            <>
              <LangRadio
                ...
                value5='c1fransiz'
                value6='c2fransiz'
                confirm1={selectValues.fransizLang === 'a1fransiz'}
                confirm2={selectValues.fransizLang === 'a2fransiz'}
                confirm3={selectValues.fransizLang === 'b1fransiz'}
                confirm4={selectValues.fransizLang === 'b2fransiz'}
                confirm5={selectValues.fransizLang === 'c1fransiz'}
                confirm6={selectValues.fransizLang === 'c2fransiz'}
                changeHandlerRadio={changeHandlerLang}
              />
              <br />
              <br />
          ...
          {selectValues.isYaponLang && (
            <> 
              <LangRadio
                ...
                value5='c1yapon'
                value6='c2yapon'
                confirm1={selectValues.yaponLang === 'a1yapon'}
                confirm2={selectValues.yaponLang === 'a2yapon'}
                confirm3={selectValues.yaponLang === 'b1yapon'}
                confirm4={selectValues.yaponLang === 'b2yapon'}
                confirm5={selectValues.yaponLang === 'c1yapon'}
                confirm6={selectValues.yaponLang === 'c2yapon'}
                changeHandlerRadio={changeHandlerLang}
              />
              <br />
              <br />
          ...
          {selectValues.isTurkLang && (
            <>
              <LangRadio
                ...
                value5='c1turk'
                value6='c2turk'
                confirm1={selectValues.turkLang === 'a1turk'}
                confirm2={selectValues.turkLang === 'a2turk'}
                confirm3={selectValues.turkLang === 'b1turk'}
                confirm4={selectValues.turkLang === 'b2turk'}
                confirm5={selectValues.turkLang === 'c1turk'}
                confirm6={selectValues.turkLang === 'c2turk'}
                changeHandlerRadio={changeHandlerLang}
              />
              <br />
              <br />
          ...
          {selectValues.isItalyanLang && (
            <LangRadio
              ...
              value5='c1italyan'
              value6='c2italyan'
              confirm1={selectValues.italyanLang === 'a1italyan'}
              confirm2={selectValues.italyanLang === 'a2italyan'}
              confirm3={selectValues.italyanLang === 'b1italyan'}
              confirm4={selectValues.italyanLang === 'b2italyan'}
              confirm5={selectValues.italyanLang === 'c1italyan'}
              confirm6={selectValues.italyanLang === 'c2italyan'}
              changeHandlerRadio={changeHandlerLang}
            />
          )}
        </div>
